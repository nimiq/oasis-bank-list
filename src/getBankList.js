...
const ECB_TIPS_XLSX_FILE_PATH = path.join(DATA_FOLDER_PATH, 'generated/ECB_TIPS.xlsx');
const ECB_TIPS_JSON_FILE_PATH = path.join(DATA_FOLDER_PATH, 'generated/ECB_TIPS.json');
